...
export function getCrisisInterventionMessage() {
  return {
    isCrisis: true,
    message: `### ❤️ Lắng nghe & Chia sẻ cùng bạn\n\nMình cảm nhận được bạn đang phải trải qua những cảm xúc vô cùng áp lực. Đừng đối mặt với nó một mình nhé.\n\nNhà trường luôn có thầy cô tư vấn tâm lý sẵn sàng lắng nghe bạn bất cứ lúc nào. Bạn có thể mở ngay mục **Góc Tâm Lý & Wellness** trên trang web hoặc liên hệ Hotline hỗ trợ tâm lý học đường: **${SUPPORT_HOTLINES.counselling}** (miễn phí 24/7), hoặc Tổng đài Quốc gia Bảo vệ Trẻ em **${SUPPORT_HOTLINES.childProtection}**.\n\nHãy dành cho bản thân một phút nghỉ ngơi và chia sẻ với người bạn tin tưởng nhé!`
  };
}
