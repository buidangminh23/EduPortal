...
function latexToHtml(latex) {
  ...
  // Named functions: \sin, \cos, \tan, \log, \ln, \text
  ...
  // Clean up leftover backslashes before commas, spaces
...
function formatTutorText(msgText) {
  let f = msgText
    ...
    .replace(/#### (.*?)\n/g, '<h5 style="color:var(--accent-primary);margin:6px 0 3px;font-weight:600;font-size:0.95em;">$1</h5>')
