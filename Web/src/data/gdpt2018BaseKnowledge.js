export const GDPT2018_BASE_KNOWLEDGE = [
    ...
    solutions: [
      {
        ...
        steps: [
          { n: 1, content: 'Tìm nguyên hàm của x: F(x) = x^2 / 2', hint: 'Áp dụng công thức nguyên hàm hàm số lũy thừa.' },
  ...
  },
  {
    ...
    solutions: [
      {
        problem: 'Cho R = 30 Ohm, Z_L = 80 Ohm, Z_C = 40 Ohm. Tính tổng trở Z.',
        steps: [
          { n: 1, content: 'Tính (Z_L - Z_C): 80 - 40 = 40 Ohm', hint: 'Lấy cảm kháng trừ dung kháng.' },
          { n: 2, content: 'Áp dụng công thức tổng trở: Z = sqrt(30^2 + 40^2) = 50 Ohm', hint: 'Bộ ba Pythagore 30-40-50.' }
        ],
        answer: '50',
        answer_locked: true
      }
