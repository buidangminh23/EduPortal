export const GDPT2018_BASE_KNOWLEDGE = [
  ...
  },
  {
    ...
    triggers: ['dao ham', 'cuc tri', 'cuc dai', 'cuc tieu', 'dao ham la gi'],
  ...
  },
  {
    ...
    triggers: ['oxyz', 'mat phong oxyz', 'toa do oxyz', 'khoang cach mat phong', 'vecto phap tuyen'],
  ...
  // ─── VẬT LÝ ───────────────────────────────────────────────────────────────
  {
    ...
    triggers: ['dong dien xoay chieu', 'mach rlc', 'tong tro rlc', 'cong huong dien'],
  ...
  // ─── HÓA HỌC ──────────────────────────────────────────────────────────────
  {
    ...
    triggers: ['kim loai kiem', 'kim loai kiem tho', 'natri tac dung voi nuoc', 'kali tac dung voi nuoc'],
  ...
  // ─── TIẾNG ANH ────────────────────────────────────────────────────────────
  {
    ...
    triggers: ['hien tai hoan thanh', 'present perfect', 'thi hien tai hoan thanh'],
